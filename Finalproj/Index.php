...
<html>
    ...
    <body>
        ...
        <form method="GET">
            ...
            <!--<br>-->
            <!--<p>Order by: </p>-->
            <!--<input <?= $_GET["orderBy"] == "inc" ? "checked" : ""; ?> -->
            <!--    type="radio" name="orderBy" id = "inc" value = "inc"> <label for="asc"> Low-High</label> <br>-->
            <!--<input <?= $_GET["orderBy"] == "des" ? "checked" : ""; ?> -->
            <!--     type="radio" name="orderBy" id = "des" value = "des"> <label for="des"> High-Low</label> <br>-->
