var gameScreen;
			...
			function init(){
				...
				//cerate two elements for background and will be added to the gameScreen
				...
				//create bullets div, as a gameobject, set size and location = to the gameScreen
			...
			function gameloop(){
				...
				for(var i=0; i<enemies.length;i++){
					...
					//collision detection enemy(one by one) via player
					// if player hits player is destroyed.
			...
			//create a new bulllet div, position it on current ship location, add then add it to bullets div
			function fire(){
				var bulletWidth = 4;
				var bulletHeight = 10;
			...
			//set positions for the enemy ship
			...
			//event listener that will call fire() when space bar is press for bullets
